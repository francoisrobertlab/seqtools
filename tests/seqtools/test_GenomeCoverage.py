...
def test_genomecov(testdir, mock_testclass):
    ...
    gc.genome_coverage_samples.assert_called_once_with(samples, genome, None, None, None, ())
...
def test_genomecov_five(testdir, mock_testclass):
    ...
    assert result.exit_code == 0
    gc.genome_coverage_samples.assert_called_once_with(samples, genome, None, None, None, ('-5',))
...
def test_genomecov_three(testdir, mock_testclass):
    ...
    assert result.exit_code == 0
    gc.genome_coverage_samples.assert_called_once_with(samples, genome, None, None, None, ('-3',))
...
def test_genomecov_parameters(testdir, mock_testclass):
    ...
    gc.genome_coverage_samples = MagicMock()
    runner = CliRunner()
    result = runner.invoke(gc.genomecov, ['-s', samples, '-g', genome, '-scale', scale, '-strand', strand, '--index', index])
    assert result.exit_code == 0
    gc.genome_coverage_samples.assert_called_once_with(samples, genome, scale, strand, index, ())
...
def test_genome_coverage_samples(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_any_call('POLR2A', genome, None, None, ())
    gc.sample_splits_genome_coverage.assert_any_call('ASDURF', genome, None, None, ())
    gc.sample_splits_genome_coverage.assert_any_call('POLR1C', genome, None, None, ())
...
def test_genome_coverage_samples_all_five(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_any_call('POLR2A', genome, None, None, ('-5',))
    gc.sample_splits_genome_coverage.assert_any_call('ASDURF', genome, None, None, ('-5',))
    gc.sample_splits_genome_coverage.assert_any_call('POLR1C', genome, None, None, ('-5',))
...
def test_genome_coverage_samples_second_five(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_called_once_with('ASDURF', genome, None, None, ('-5',))
...
def test_genome_coverage_samples_all_three(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_any_call('POLR2A', genome, None, None, ('-3',))
    gc.sample_splits_genome_coverage.assert_any_call('ASDURF', genome, None, None, ('-3',))
    gc.sample_splits_genome_coverage.assert_any_call('POLR1C', genome, None, None, ('-3',))
...
def test_genome_coverage_samples_second_three(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_called_once_with('ASDURF', genome, None, None, ('-3',))
...
def test_genome_coverage_samples_all_scale(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_any_call('POLR2A', genome, scale, None, ())
    gc.sample_splits_genome_coverage.assert_any_call('ASDURF', genome, scale, None, ())
    gc.sample_splits_genome_coverage.assert_any_call('POLR1C', genome, scale, None, ())
...
def test_genome_coverage_samples_second_scale(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_called_once_with('ASDURF', genome, scale, None, ())
...
def test_genome_coverage_samples_all_scale_negativestrand(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_any_call('POLR2A', genome, scale, strand, ())
    gc.sample_splits_genome_coverage.assert_any_call('ASDURF', genome, scale, strand, ())
    gc.sample_splits_genome_coverage.assert_any_call('POLR1C', genome, scale, strand, ())
...
def test_genome_coverage_samples_second_scale_negativestrand(testdir, mock_testclass):
    ...
    gc.sample_splits_genome_coverage.assert_called_once_with('ASDURF', genome, scale, strand, ())
...
def test_sample_splits_genome_coverage(testdir, mock_testclass):
    ...
    gc.genome_coverage.assert_any_call(sample, genome, None, None, ())
    gc.genome_coverage.assert_any_call(split1, genome, None, None, ())
    gc.genome_coverage.assert_any_call(split2, genome, None, None, ())
...
def test_sample_splits_genome_coverage_five(testdir, mock_testclass):
    ...
    sb.splits.assert_called_once_with(sample)
    gc.genome_coverage.assert_any_call(sample, genome, None, None, ('-5'))
    gc.genome_coverage.assert_any_call(split1, genome, None, None, ('-5'))
    gc.genome_coverage.assert_any_call(split2, genome, None, None, ('-5'))
...
def test_sample_splits_genome_coverage_three(testdir, mock_testclass):
    ...
    sb.splits.assert_called_once_with(sample)
    gc.genome_coverage.assert_any_call(sample, genome, None, None, ('-3'))
    gc.genome_coverage.assert_any_call(split1, genome, None, None, ('-3'))
    gc.genome_coverage.assert_any_call(split2, genome, None, None, ('-3'))
...
def test_sample_splits_genome_coverage_scale(testdir, mock_testclass):
    ...
    sb.splits.assert_called_once_with(sample)
    gc.genome_coverage.assert_any_call(sample, genome, scale, None, ())
    gc.genome_coverage.assert_any_call(split1, genome, scale, None, ())
    gc.genome_coverage.assert_any_call(split2, genome, scale, None, ())
...
def test_sample_splits_genome_coverage_negativestrand(testdir, mock_testclass):
    ...
    sb.splits.assert_called_once_with(sample)
    gc.genome_coverage.assert_any_call(sample, genome, None, strand, ())
    gc.genome_coverage.assert_any_call(split1, genome, None, strand, ())
    gc.genome_coverage.assert_any_call(split2, genome, None, strand, ())
...
def test_sample_splits_genome_coverage_scale_negativestrand(testdir, mock_testclass):
    ...
    sb.splits.assert_called_once_with(sample)
    gc.genome_coverage.assert_any_call(sample, genome, scale, strand, ())
    gc.genome_coverage.assert_any_call(split1, genome, scale, strand, ())
    gc.genome_coverage.assert_any_call(split2, genome, scale, strand, ())
...
def test_genome_coverage(testdir, mock_testclass):
    ...
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, BASE_SCALE / count, None, ())
...
def test_genome_coverage_five(testdir, mock_testclass):
    ...
    Bed.count_bed.assert_called_once_with(forcov)
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, BASE_SCALE / count, None, ('-5'))
    Bed.bedgraph_to_bigwig.assert_called_once_with(cov, bw, genome)
...
def test_genome_coverage_three(testdir, mock_testclass):
    ...
    Bed.count_bed.assert_called_once_with(forcov)
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, BASE_SCALE / count, None, ('-3'))
    Bed.bedgraph_to_bigwig.assert_called_once_with(cov, bw, genome)
...
def test_genome_coverage_scale(testdir, mock_testclass):
    ...
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, scale, None, ())
    Bed.bedgraph_to_bigwig.assert_called_once_with(cov, bw, genome)
...
def test_genome_coverage_negativestrand(testdir, mock_testclass):
    ...
    Bed.count_bed.assert_called_once_with(forcov)
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, BASE_SCALE / count, strand, ())
    Bed.bedgraph_to_bigwig.assert_called_once_with(cov, bw, genome)
...
def test_genome_coverage_scale_negativestrand(testdir, mock_testclass):
    ...
    Bed.count_bed.assert_not_called()
    gc.coverage.assert_called_once_with(forcov, cov, genome, sample, scale, strand, ())
    Bed.bedgraph_to_bigwig.assert_called_once_with(cov, bw, genome)
